...
model_quantization_finetune_dict = {'Llama-2-7b-chat-hf-finetune-omniscien-finetuned-dataset' : {"model_type":"adapter"},
                                    'merge_model_version' : {"model_type":"full-model"}
}
...
model_metadata = {
    ...
    "Llama-2-7b-chat-hf-finetune-omniscien-finetuned-dataset" : {"max_token" : 2048,
                                                                "task" : "text-generation",
                                                                "temperature" : 0}
    "merge_model_version" : {"max_token" : 2048,
                    "task" : "text-generation",
                    "temperature" : 0}
}
